...
import { computeLabel } from "../actions.jsx";
...
class Calculator extends Component {
        ...
        swal(
          {
            ...
            text:
              "Bedankt voor je bijdrage! We zijn nu druk bezig om je nieuwe Waterlabel opnieuw op de kaart te zetten. Klik op OK om de nieuwe kaart te bekijken. Dit kan maximaal 5 seconden duren. Een momentje geduld s.v.p...",
            type: "success",
          ...
          () => {
            setTimeout(() => {
              swal({
                ...
                text:
                  "Bedankt voor het wachten, je Waterlabel is opnieuw gegenereerd.",
                type: "success"
              });
  ...
  render() {
    ...
    if (
      ...
      streetviewLocation = `${postcode.selectedObject.properties
        .street} ${postcode.selectedObject.properties.housenumber}, ${postcode
        .selectedObject.properties.city}`;
    }

    const initialLocation = {
      lat:
        postcode && postcode.maplocation && postcode.maplocation.lng
          ? Number(postcode.maplocation.lng)
          : 52.1741,
      lng:
        postcode && postcode.maplocation && postcode.maplocation.lat
    ...
    const calculationvalues =
      postcode && postcode.selectedObject
      ...
      <Grid fluid>
        <Row>
          <Col md={6}>
            <div className={styles.Intro}>
              ...
              <p>
                ...
                regenwaterbestendiger kunt maken.
              </p>
              <p>
                Hoe beter je het water vasthoudt op eigen perceel, hoe beter je
                waterlabel.
              </p>
              <p>Hierdoor belast je de riolering niet onnodig.</p>
              <p>
                <strong>
                  Bereken hier jouw waterlabel en bekijk wat je kunt doen, zo
                  maken we Nederland samen klimaatbestendig!
                </strong>
              </p>
            </div>

            <Tabs defaultActiveKey={1} id="calculator-stappen">
              <Tab eventKey={1} title="Perceeloppervlak">
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover
                          ...
                          title="Dak woning (m2)"
                        >
                          <img style={{ width: "100%" }} src={tt02} />
                          Het oppervlak van het dak van de woning of het
                          (hoofd)gebouw.&nbsp; Bij schuine daken telt het
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        ...
                        >
                          ...
                          Het perceel is het totale oppervlak van het gebouw en
                          de eventuele achtertuin, voortuin en schuur samen.
                        </Popover>
                      }
                    >
                      <i
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-5">
                    ...
                    >
                      ...
                      <option value="Regenwater stelsel">
                        Regenwater riool
                      </option>
                      <option value="Infiltratieriool">
                        Infiltratie riool
                      </option>
                  ...
                  <label htmlFor="" className="col-sm-5 form-control-label">
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        ...
                        >
                          <img style={{ width: "100%" }} src={tt08} />
                          De dakberging is het oppervlak van de schuur of garage
                          dat tenminste 2 cm water kan vasthouden. Dit kan
                          bijvoorbeeld dak zijn met beplanting (een groen dak)
                          of met een waterberging (een blauw dak).
                          <br />
                          <a
                  ...
                  <label htmlFor="" className="col-sm-5 form-control-label">
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        ...
                        >
                          <img style={{ width: "100%" }} src={tt11} />
                          Het oppervlak in de achtertuin waar regen direct in de
                          grond kan zakken, zoals gras, kiezels of aarde.
                          <br />
                          <a
                            target="_blank"
                  ...
                  <label htmlFor="" className="col-sm-5 form-control-label">
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        ...
                        >
                          <img style={{ width: "100%" }} src={tt10} />
                          Het oppervlak in de voortuin waar regen direct in de
                          grond kan zakken, zoals gras, kiezels of aarde.
                          <br />
                          <a
                            target="_blank"
                  ...
                  <label htmlFor="" className="col-sm-5 form-control-label">
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        ...
                        >
                          <img style={{ width: "100%" }} src={tt12} />
                          Een regenton voorkomt dat water al tijdens een bui
                          afstroomt. Zo wordt de piekbelasting afgezwakt. Ook de
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        ...
                        >
                          ...
                          de straatkant en een tuintje aan te leggen, kan het
                          van de gevel afstromende regenwater in de grond
                          infiltreren.
                          <br />
                          <a
                            target="_blank"
          ...
          <Col md={6}>
                ...
                <ol className={styles.labels}>
                  <li>
                    ...
                    {calculator.label === "A"
                      ? <svg className={styles.labelA} width="48.5" height="17">
                          <text style={{ fill: "black" }} x="10" y="13">
                            &larr;
                          </text>
                        </svg>
                      : ""}
                  ...
                  <li>
                    <svg className={styles.labelB} width="98.5" height="17">
                      <polygon points="0,0 90,0 98.5,8.5 90,17 0,17" />
                      <text style={{ fill: "white" }} x="2" y="13">
                        B
                      </text>
                    </svg>
                  ...
                  <li>
                    <svg className={styles.labelC} width="88.5" height="17">
                      <polygon points="0,0 80,0 88.5,8.5 80,17 0,17" />
                      <text style={{ fill: "white" }} x="2" y="13">
                        C
                      </text>
                    </svg>
                  ...
                  <li>
                    <svg className={styles.labelD} width="78.5" height="17">
                      <polygon points="0,0 70,0 78.5,8.5 70,17 0,17" />
                      <text style={{ fill: "white" }} x="2" y="13">
                        D
                      </text>
                    </svg>
                  ...
                  <li>
                    <svg className={styles.labelE} width="68.5" height="17">
                      <polygon points="0,0 60,0 68.5,8.5 60,17 0,17" />
                      <text style={{ fill: "white" }} x="2" y="13">
                        E
                      </text>
                    </svg>
                  ...
                  <li>
                    <svg className={styles.labelF} width="58.5" height="17">
                      <polygon points="0,0 50,0 58.5,8.5 50,17 0,17" />
                      <text style={{ fill: "white" }} x="2" y="13">
                        F
                      </text>
                    </svg>
            ...
            <h2 className={styles.GroupLabel}>Wat kan ik doen?</h2>
            <p>Je kunt de volgende maatregelen nemen:</p>
            <ul>
              <li>
                <a
                  href="https://www.rainproof.nl/toolbox/maatregelen/infiltratiekratten"
                  target="_blank"
                >
                  Plaats een Infiltratiekrat
                </a>
              </li>
              <li>
                <a
